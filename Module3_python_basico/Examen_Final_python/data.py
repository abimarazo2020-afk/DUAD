...
def write_data_in_CSV(file_path, students_list): #students_list va a guardar list_dic de actions.
    headers = [ 'student_name', 'student_section', 'spanish_note', 'math_note', 'english_note', 'scient_note', 'social_note']
